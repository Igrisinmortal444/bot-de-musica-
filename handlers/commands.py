...
HOME_TEXT = (
    "🎧 <b>MUSIC POWER BOT</b> 🎧\n" + SEP + "\n\n"
    "¡Mándeme un <b>cantante</b> y/o <b>nombre de una canción</b> "
    "y encontraré la música para usted! 🎵\n\n"
    "¡Envíame un <b>mensaje de voz</b> y <b>reconoceré la canción</b>! 🎤\n\n"
    "Envía un <b>archivo de audio</b> para guardarlo en la base de datos y "
    "dejarlo disponible para búsqueda. 📚\n\n"
    + SEP + "\n\n"
    "📚 <b>Comandos</b>\n"
    "• /song — buscar por título\n"
    "• /artist — buscar por cantante\n"
    "• /search — búsqueda global\n"
    "• /link — descargar por enlace\n"
    "• /my — tu lista de reproducción\n"
    "• /top — canciones populares\n"
...
HELP_TEXT = (
    ...
    "🎤 <b>Reconocimiento de voz</b>\n"
    "→ manda un mensaje de voz y te digo qué canción es, con su descarga.\n\n"
    "🎵 <b>Buscar por título</b>\n"
    "→ <code>/song Despacito</code> (o escribe el nombre directo)\n\n"
    "🎤 <b>Buscar por cantante</b>\n"
    "→ <code>/artist Bad Bunny</code>\n\n"
    "🔗 <b>Descargar por enlace</b>\n"
    "→ <code>/link https://www.youtube.com/watch?v=…</code>\n"
    "→ acepto YouTube, Spotify, SoundCloud, Deezer, Vimeo y más\n\n"
    "📚 <b>Biblioteca</b>\n"
    "→ sube un audio y queda guardado y buscable con /song\n\n"
    "📃 <b>Tu música</b>\n"
    "→ /my tu lista de reproducción\n"
    "→ /top canciones populares\n"
    "→ /settings cambiar calidad, carátulas y auto-guardado\n\n"
